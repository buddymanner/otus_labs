...
# **Топология**
![This topology has two PCs, a router R1 and a switch S1. PC-A is connected to switch S1 F0/6. Switch S1 F0/5 is connected to R1  G0/0/1. Router R1 g0/0/0 is connected to PC-B.](Aspose.Words.a5143ccb-9f88-4855-bad5-12803d592e5a.001.png)
# **Таблица адресации**
...
*Конец документа*
© a 2013 г. - гггг Корпорация Cisco и/или ее дочерние компании. Все права защищены. Открытая информация Cisco 	страница 2** 4**	www.netacad.com
