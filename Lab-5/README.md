...
![Реализованная в СPT_8.1 топология](init_done_sheme.png)


b) проинициализируем устройства
...
1. Запретим нежелательный поиск в DNS.
1. Настроим описания интерфейса для портов, которые используются в S1 и S2.
1. Установим для шлюза по умолчанию для VLAN управления значение 192.168.10.1 на обоих коммутаторах.
