...
1. Теперь подключимся к коммутаторам S1 и S2 через консоль и введите команду **show interface F0/1** на каждом коммутаторе.
...
1. ### **Посмотрим таблицу МАС-адресов коммутатора.**
Подключитесь к коммутатору S2 через консоль и просмотрите таблицу МАС-адресов до и после тестирования сетевой связи с помощью эхо-запросов.

1. Подключимся к коммутатору S2 через консоль и войдем в привилегированный режим EXEC.

1. В привилегированном режиме EXEC введем команду **show mac address-table** и нажмите клавишу ввода.
...
1. Снова быстро введем команду **show mac address-table**.

Видим, что результат  изменился и мы снова видим  МАС адрес коммутатора S1:
...
- ___Да, указан в Vlan 1 МАС адрес коммутатра S1.  Нет, другие МАС адреса не указаны.___
...
----    -----------       --------    -----
   ...
   1    0004.9ae7.9b01    DYNAMIC     Fa0/1
   1    0007.ec4b.bbc2    DYNAMIC     Fa0/18
...
#### Ответ: 
- ___В крупных сетях из-за большого количества узлов и соответственно повышенного широковещательного трафика может возрастать количество коллизий и снижение пропускной способности локальных сетей в отношении полезноого, т.е пользовательского трафика. Поэтому при количестве узлов больше чем 300 целезобразнее разбивать большие сети на более маленькие и переводить их во вланы (Vlan), чтобы изолировать пользовательский трафик между собой и повысить не только производительность сети, но и безопасность.___
