...
# **Топология**
![There are two switches and two PCs in the topology. PC-A is connected to S1 via F0/6. S1 F0/1 is connected to S2 F0/1. PC-B is connected to S2 via F/18.](Aspose.Words.e94ba300-9eda-48d8-9efb-e4085ac5c5cd.001.png)
# **Таблица адресации**
